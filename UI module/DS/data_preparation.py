...
def process_sec_filings(file_path, chunk_size=1000, output_dir="./FAISS_INDEX",chunk_dir ="./FAISS_INDEX/chunks/"):
    ...
    for idx, chunk in enumerate(chunks):
        ...
        with open(chunk_file_path, 'a', encoding='utf-8') as chunk_file:
    ...
    with open(os.path.join(output_dir, "chunk_file_map.json"), 'a', encoding='utf-8') as map_file:
        json.dump(chunk_file_map, map_file)

if __name__ == "__main__":
    sec_file_path = './data.txt'
